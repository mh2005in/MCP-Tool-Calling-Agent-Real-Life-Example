...
public class IntakeController {
    ...
    public ResponseEntity<List<IntakeResponseDto>> getResponses(@PathVariable Long caseId) {
        return ResponseEntity.ok(intakeService.getResponses(caseId));
    }

    @GetMapping(ApiPaths.INTAKE_SUMMARY)
    public ResponseEntity<IntakeSummaryDto> getSummary(@PathVariable Long caseId) {
    ...
    public ResponseEntity<List<ChecklistItemDto>> generateChecklist(@PathVariable Long caseId) {
        return ResponseEntity.status(HttpStatus.CREATED)

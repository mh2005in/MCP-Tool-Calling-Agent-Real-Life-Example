...
public class McpToolAuditLog extends BaseEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "mcp_tool_audit_log_gen")
    @SequenceGenerator(name = "mcp_tool_audit_log_gen", sequenceName = "mcp_tool_audit_log_seq", allocationSize = 1)
    private Long id;

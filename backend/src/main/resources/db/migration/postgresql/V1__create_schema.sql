...
CREATE SEQUENCE IF NOT EXISTS consultants_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS clients_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS immigration_cases_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS documents_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS checklist_items_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS checklist_templates_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS intake_question_templates_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS intake_responses_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS reminders_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS audit_logs_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS conditional_rules_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS party_profiles_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS travel_history_entries_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS work_history_entries_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS relationship_timeline_entries_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS recruitment_evidence_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS candidate_comparisons_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS expiry_alerts_seq START WITH 1 INCREMENT BY 1;

-- ======================== TABLES ========================

-- Consultants
CREATE TABLE consultants (
    id                BIGINT       NOT NULL DEFAULT nextval('consultants_seq'),
...
CREATE TABLE immigration_cases (
    id                        BIGINT       NOT NULL DEFAULT nextval('immigration_cases_seq'),
...
CREATE TABLE checklist_items (
    id                       BIGINT       NOT NULL DEFAULT nextval('checklist_items_seq'),
    case_id                  BIGINT       NOT NULL,
...
CREATE TABLE checklist_templates (
    id                          BIGINT       NOT NULL DEFAULT nextval('checklist_templates_seq'),
    service_type                VARCHAR(50)  NOT NULL,
    category                    VARCHAR(255) NOT NULL,
    document_name               VARCHAR(255) NOT NULL,
    description                 TEXT,
...
CREATE TABLE intake_question_templates (
    id                  BIGINT       NOT NULL DEFAULT nextval('intake_question_templates_seq'),
    service_type        VARCHAR(50)  NOT NULL,
...
CREATE TABLE intake_responses (
    id                 BIGINT       NOT NULL DEFAULT nextval('intake_responses_seq'),
    case_id            BIGINT       NOT NULL,
    section_name       VARCHAR(255) NOT NULL,
    question_key       VARCHAR(255) NOT NULL,
    question_label     VARCHAR(255) NOT NULL,
...
CREATE TABLE reminders (
    id            BIGINT       NOT NULL DEFAULT nextval('reminders_seq'),
    case_id       BIGINT       NOT NULL,
...
CREATE TABLE audit_logs (
    id           BIGINT       NOT NULL DEFAULT nextval('audit_logs_seq'),
...
CREATE TABLE conditional_rules (
    id                          BIGINT       NOT NULL DEFAULT nextval('conditional_rules_seq'),
    service_type                VARCHAR(50)  NOT NULL,
...
CREATE TABLE party_profiles (
    id             BIGINT       NOT NULL DEFAULT nextval('party_profiles_seq'),
    case_id        BIGINT       NOT NULL,
...
CREATE TABLE travel_history_entries (
    id          BIGINT       NOT NULL DEFAULT nextval('travel_history_entries_seq'),
    case_id     BIGINT       NOT NULL,
...
CREATE TABLE work_history_entries (
    id                        BIGINT       NOT NULL DEFAULT nextval('work_history_entries_seq'),
    case_id                   BIGINT       NOT NULL,
...
CREATE TABLE relationship_timeline_entries (
    id                BIGINT       NOT NULL DEFAULT nextval('relationship_timeline_entries_seq'),
    case_id           BIGINT       NOT NULL,
...
CREATE TABLE recruitment_evidence (
    id                   BIGINT       NOT NULL DEFAULT nextval('recruitment_evidence_seq'),
    case_id              BIGINT       NOT NULL,
...
CREATE TABLE candidate_comparisons (
    id               BIGINT       NOT NULL DEFAULT nextval('candidate_comparisons_seq'),
    case_id          BIGINT       NOT NULL,
...
CREATE TABLE expiry_alerts (
    id                    BIGINT       NOT NULL DEFAULT nextval('expiry_alerts_seq'),
    case_id               BIGINT       NOT NULL,
